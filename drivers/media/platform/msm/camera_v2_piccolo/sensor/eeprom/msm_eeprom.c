...
static int msm_eeprom_platform_probe(struct platform_device *pdev)
{
	...
	if((eb_info->eeprom_name != NULL) && ((strcmp(eb_info->eeprom_name,"imx214_olqba15") == 0)||(strcmp(eb_info->eeprom_name,"imx214_f13n05e") == 0)))
	{
		CDBG("imx214 name = %s\n",eb_info->eeprom_name);
		imx214_set_otp_module_id(e_ctrl);
	}
	else if((eb_info->eeprom_name != NULL) && ((strcmp(eb_info->eeprom_name,"s5k5e2_olq5f20") == 0)||(strcmp(eb_info->eeprom_name,"s5k5e2_cma189") == 0)))
	{
